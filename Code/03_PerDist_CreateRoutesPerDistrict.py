...
def generateGPX(Inp_listforMerge,Inp_path,Inp_dist,Inp_base,Inp_d,Inp_StagePre, Inp_segType,Inp_count, Inp_subseq, Inp_listSegType,
    ...
    arcpy.gp.FeaturesToGPX("{}/RoutesMergedDissolved_Dist{}_Base{}_Day{}_Stage{}".format(Inp_path,Inp_dist, Inp_BaseName,Inp_d,Inp_Stage),
                        "OutputVRP/{}/Base{}{}/Day{}/Trk_Dist{}_B{}_D{}_St{}Pre.gpx".format(Inp_dist,nameAdd2, Inp_base,Inp_d,Inp_dist, Inp_BaseName,Inp_d,Inp_Stage), True, True)
...
def PerDist_function(Routes,Orders, nameAdd1, nameAdd2,count):
    ...
    for base in range(1, count + 1):
        ...
        for day in range(1,27): # loop over all possible days
            ...
            if "Route{}{}_{}".format(nameAdd1,base, day) in RouteValues:
                ...
                listSegEndLon=[]
                try:
                    shutil.rmtree("OutputVRP/{}/Base{}{}/Day{}".format(dist,nameAdd2,base,d))
                except:
